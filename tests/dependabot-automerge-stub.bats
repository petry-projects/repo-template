...
# channel pin on the `uses:` ref. Any other diff is drift — the silent-revert class
# of failure the fleet stub-drift monitor exists to catch (fleet_stub_drift.sh).
#
